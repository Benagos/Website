...
const Orbital = () => {
  const infra = [
    ...
    { icon: "/card.svg", name: <p>Payments</p> },
    {
      icon: "/verify.svg",
      name: (
        <p>
  ...
  const digital = [
    { icon: "/apple.svg", name: "iOS app" },
    { icon: "/android.svg", name: "Android app" },
    { icon: "/case.svg", name: "Business app" },
  ];
  ...
  return (
    <div className="font-instrument" id="orbital">
      <div className="h-2 lg:h-4 w-full bg-white" />
      <div className="bg-[#0F0F0F] flex flex-col relative overflow-hidden">
        <div className="max-w-[1200px] mx-auto pt-20 lg:pt-32 px-3 sm:px-6 lg:px-10 xl:px-0 z-10 w-full">
          <motion.div
          ...
          <motion.p
            className="text-center mx-auto text-4xl font-semibold text-white mt-6"
            initial={{ y: 40, opacity: 0 }}
            whileInView={{ y: 0, opacity: 1 }}
            transition={{ ease: "easeInOut", duration: 0.3, delay: 0.3 }}
            viewport={{ once: true }}
          >
            Ship compliant bank-grade apps
            <br /> in weeks, not months.
          </motion.p>

          <motion.p
            className="text-center mx-auto text-[15px] text-[#C8CEDE] mt-3"
            initial={{ y: 40, opacity: 0 }}
            whileInView={{ y: 0, opacity: 1 }}
            transition={{ ease: "easeInOut", duration: 0.3, delay: 0.4 }}
            viewport={{ once: true }}
          >
            Design your app, connect your existing core banking system or custom
            APIs, configure your customer
            <br className="hidden lg:flex" /> journeys, deploy to iOS and
            Android, and manage on the go.
          </motion.p>

          <div className="flex flex-col sm:flex-row items-center gap-4 mx-auto w-fit mt-10">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Link href="mailto:orbital@benagos.com">
                <CustomButton
                  name="Contact us"
                  className="bg-[#2A2C2F] border border-[#2A2C2F] hover:border-white hover:bg-transparent"
                />
              </Link>
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Link href="https://orbital.benagos.com/">
                <CustomButton
                  name="Explore Orbital"
                  className="border-2 border-blue hover:bg-blue w-full sm:w-fit"
                ...
                <div className="w-full sm:w-fit flex flex-row sm:flex-none sm:grid sm:grid-cols-4 gap-3 mt-7 lg:flex lg:flex-col lg:gap-6">
                  {infra.map((item, i) => (
                    <div
                      ...
                      className="bg-[#2A2C2F] flex flex-col justify-center items-center gap-2 rounded-sm w-full sm:w-35 h-25"
                    >
                ...
                <div className="grid grid-cols-3 gap-4 mt-7 lg:flex lg:flex-col lg:gap-6">
                  {digital.map((item, i) => (
                    <div
                      ...
                      className="bg-[#2A2C2F] flex flex-col justify-center items-center gap-2 rounded-sm w-25 lg:w-35 h-25"
                    >
                      <Image
                        src={item.icon}
                        alt={item.name}
        ...
        <div className="absolute top-75 h-full inset-x-0 pointer-events-none opacity-30 ">
          <div className="relative w-full h-full">
            <Image src="/mesh.svg" alt="" className="object-cover" fill />
          </div>
        </div>
      </div>
    </div>
