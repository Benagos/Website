      ...
      <div className="max-w-[1400px] w-full mx-auto py-25 px-3 sm:px-6 lg:px-10 2xl:px-0">
        <div className="flex flex-col xl:flex-row justify-between w-full gap-10 xl:gap-0">
          <p className="max-w-sm text-sm font-light text-white -tracking-[0.2px]">
            Benagos is a product studio on a mission to build human-first
            digital tools for connection, creativity, clarity, and change. Each
            of our products is a petal, blooming from one vision: to make the
            ...
            {[
              {
                ...
                items: [
                  ...
                  {
                    name: "Orbital",
                    link: "https://orbital.benagos.com/",
                  },
                ],
              },
              {
                ...
                items: [
                  {
                    ...
                    link: "https://benagos.notion.site/LilyPad-Commons-1bf3c9f91dc78036a643f9967832f96f?source=copy_link",
                  },
                  // {
              ...
              <div key={index}>
                <p className="font-semibold text-[15px] text-[#979797] -tracking-[0.5px]">
                  {f?.name}
                </p>
                <div className="font-light text-[13px] text-white flex flex-col gap-3 sm:gap-4 mt-4">
                  {f?.items?.map((m: any, index: number) => (
                    ...
                    >
                      <div className="max-w-xs -tracking-[0.2px]">
                        {m?.name}
                      </div>
                    </Link>
                  ))}
        ...
        <div className="my-7 justify-between w-full flex flex-col sm:flex-row sm:items-center gap-5">
          ...
          <div className="flex items-center">
            {[
              ...
              {
                name: "Cookie Policy",
                link: "https://benagos.notion.site/Benagos-Cookie-Policy-2dd3c9f91dc78125afb9fca236ee0738?source=copy_link",
              },
              {
                name: "Brand Guide",
                link: "https://benagos.notion.site/Benagos-Brand-Guide-2e73c9f91dc780559ae6cb464ca1830e?source=copy_link",
              },
              ...
              >
                ...
                {arr?.length - 1 !== index && (
                  <Dot className="text-white size-5 mx-1" />
                )}
              </Link>
            ))}
          </div>
